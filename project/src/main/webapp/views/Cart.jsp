...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="https://i.pinimg.com/736x/09/3b/35/093b35c4ce70280594a43f59a1d4dac1--portfolio-ideas-logo-s.jpg" height="77" width="77" style="font-family: monotype corsiva;" /><b>ShoeHeaps</b></h1>
	</center>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (id) {
         $http['delete']('http://localhost:8080/shoeheaps/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/shoeheaps/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8080/shoeheaps/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8080/shoeheaps/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
